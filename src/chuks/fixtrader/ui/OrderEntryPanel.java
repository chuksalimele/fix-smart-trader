...
import chuks.fixtrader.DoubleNumberTextField;
import chuks.fixtrader.OrderSide;
import chuks.fixtrader.OrderTIF;
import chuks.fixtrader.OrderTableModel;
import chuks.fixtrader.LogonEvent;
import chuks.fixtrader.OrderType;
...
public class OrderEntryPanel extends JPanel implements Observer {
    ...
    private SmartTraderApplication application = null;

    private GridBagConstraints constraints = new GridBagConstraints();

    public OrderEntryPanel(final OrderTableModel orderTableModel,
                           final SmartTraderApplication application) {
