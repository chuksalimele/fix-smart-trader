 ...
 *  Main content panel
 */
public class SmartTraderPanel extends JPanel
    implements Observer, ActionListener {

    private static Category log =
        Category.getInstance(SmartTraderPanel.class.getName());
    ...
    public SmartTraderPanel(OrderTableModel orderTableModel,
