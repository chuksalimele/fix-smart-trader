...
import chuks.fixtrader.IntegerNumberTextField;
...
public class CancelReplacePanel extends JPanel {
    ...
    private SmartTraderApplication application;

    public CancelReplacePanel(final SmartTraderApplication application) {
