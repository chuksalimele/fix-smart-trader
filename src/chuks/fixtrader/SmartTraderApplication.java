...
import quickfix.*;
import chuks.fixtrader.Order;
import java.util.logging.Level;
import java.util.logging.Logger;
import quickfix.field.*;
import javax.swing.SwingUtilities;

public class SmartTraderApplication implements Application {
    ...
    public SmartTraderApplication(OrderTableModel orderTableModel,
    ...
    public void toAdmin(quickfix.Message message,
        ...
        try {
            ...
            Logger.getLogger(SmartTraderApplication.class.getName()).log(Level.SEVERE, null, ex);
        }  						
    ...
    private void executionReport(Message message, SessionID sessionID) throws FieldNotFound {
        ...
        try {
            ...
            double diff = order.getQuantity() - (double)orderQty.getValue();
            order.setQuantity((double)orderQty.getValue());
	...
	newOrderSingle.setString(Account.FIELD, "fixclient8");
        
        //newOrderSingle.setString(1001, "20");//take profit pips
        //newOrderSingle.setString(1003, "20");//stop loss pips
